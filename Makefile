...
generate_statefiles:
	...
	python3 nics_prep_2D.py  --increment 0.1  --step 0.1  --nval 5  --offset 0.5  test/test006/_5_helicene.xyz  --bounds -2.5 2.5 -2.5 2.5
	mv state.json test/test006/
	python3 nics_prep_2D.py  --increment 0.1  --step 0.1  --nval 5  --offset 0.5  test/test007/_5_helicene.xyz  --bounds -2.5 2.5 -2.5 2.5
	mv state.json test/test007/
...
generate_comfiles:
	...
	python3 nics_prep_2D.py  --increment 0.1  --step 0.1  --nval 5  --offset 0.5  test/test007/_5_helicene.xyz  --bounds -2.5 2.5 -2.5 2.5
	mv input_cycle_* test/test007/com
